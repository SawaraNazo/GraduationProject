...
void TitleAniLayer::createLabels()
{
	...
	labelT1 = Label::createWithSystemFont(laT1, "arial", 50);
	...
	labelT2 = Label::createWithSystemFont(laT2, "arial", 40);
	...
	labelT3 = Label::createWithSystemFont(laT3, "arial", 35);
	...
	labelT4 = Label::createWithSystemFont(laT4, "arial", 30);
